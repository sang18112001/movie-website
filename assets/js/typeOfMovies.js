...
function show_movies(movies_info) {
  ...
  movies.forEach((movie) => {
    ...
    fetch(
      `https://api.themoviedb.org/3/movie/${movie.id}?api_key=3fd2be6f0c70a2a598f084ddfb75487c`
    )
      .then((res) => res.json())
      .then((specificMovie) => {
          ...
          <div class="body-card">
            ...
            <div class="card-content">
                ...
                <div class="content-info">
                  <span class="content-year">${movie.release_date.slice(
                    0,
                    4
                  )}</span>
...
function filterPerforming() {
  ...
  checkboxes.forEach((checkbox) => {
    checkbox.addEventListener("change", () => {
      ...
      checkbox.checked
        ? listFilter.add(requiredFilter)
        : listFilter.delete(requiredFilter);
    });
  });
